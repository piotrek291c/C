...
{
    printf("Size of sint8: %ld\n", sizeof(sint8));
    printf("Size of sint16: %ld\n", sizeof(sint16));
    printf("Size of sint32: %ld\n", sizeof(sint32));
    printf("Size of sint64: %ld\n", sizeof(sint64));
    printf("Size of uint8: %ld\n", sizeof(uint8));
    printf("Size of uint16: %ld\n", sizeof(uint16));
    printf("Size of uint32: %ld\n", sizeof(uint32));
    printf("Size of uint64: %ld\n", sizeof(uint64));
    printf("Size of float32: %ld\n", sizeof(float32));
    printf("Size of float64: %ld\n", sizeof(float64));
    ...
    printf("Size of bufferSizeArray: %ld\n", sizeof(bufferSizeArray));
    printf("Size of bufferArray: %ld\n", sizeof(bufferArray));
    printf("Size of bufferArray[0]: %ld\n", sizeof(bufferArray[0]));
    printf("Size of bufferSize: %d\n", bufferSize);

    sint8 tekst[] = "123456789";
    sint8 *pt = tekst;
    printf("Size of tekst: %ld\n", sizeof(tekst));
    printf("Size of tekst[0]: %ld\n", sizeof(tekst[0]));
